...
id: "kiss5"
    ...
    alt: "The author demonstrates the probability wheel interactive in the *Genome* exhibit at NMNH. The video is recorded with a first-person point of view. The interactive is on a panel rather than a screen. At the top of the interactive there is an image of a man with gray hair, along with text that reads: “Diagnosis: Carl, age 65, does NOT have a genetic risk factor for lung cancer.” Embedded in the table is a cylindrical wheel oriented horizontally. The wheel is divided into four vertical sections, each corresponding to one of the four choices of how many cigarettes per day Carl smokes. The four options are listed above the wheel, with a slider that can point to one of the options: “0 cigarettes per day,” “5 cigarettes per day,” “10 cigarettes per day,” and “40 cigarettes per day.” Part 2 of the instructions reads: “Lifestyle: SLIDE THE ARROW,” and decide how much Carl smokes.” The “0 cigarettes” section on the wheel has only a few very fine black horizontal lines around the wheel. The “5 cigarettes” section has slightly more of the same black lines. The “10 cigarettes” section has a few slightly thicker black lines on it. Finally, the “40 cigarettes” section has several slightly thicker black lines on it. There is a large horizontal red line that is superimposed over the wheel. Part 3 of the instructions reads: “Chance: SPIN THE WHEEL. If the red and black bars line up, Carl develops lung cancer.” When spun, the wheel settles in a random spot relative to the red line. In the video, “10 cigarettes per day” is chosen. When the wheel is spun, the wheel lands so that the red line is surrounded by white space. It is not touching the black bar in the “10 cigarettes per day” section of the wheel."
...
id: "kiss8"
    ...
    alt: "The author demonstrates the *Morph Station* in the Hall of Human Origins at NMNH. The video is recorded with a first-person point of view. The interactive prepares to take a photo of the author, and the screen shows an image of her face, a young woman with brown hair, with a map of a generalized face regions (eyes, mouth, nose, and ears) superimposed on top. There are arrows pointing to the camera above the screen, with text reading “Look Here.” The instructions read: “Line up your face with the markings on the screen. Press ‘Take Your Picture’ when your eyes and mouth are lined up.” A button in the bottom right of the screen reads “Take Your Picture.” A countdown from 3 begins, and a flash shows as the photo is taken. The screen then shows the photo that was taken, with text that reads: “Does your photo line up with the white guide lines? If it does, press ‘Done.’ If it does not, use the control at right to adjust, or press ‘Re-take.’” On the right of the screen, there is an option that reads “Adjust Location” with four arrows: up, down, left, and right. There is also an option that reads “Adjust Size” with plus and minus buttons. The photo is then properly centered with the controls, and the “Done” button is pressed. The next screen reads “Choose the early human species you want to become.” There are eight options, each paired with a photo of a model of that species: “*Sahelanthropus tchadensis* – had the two earliest traits that distinguish humans from other primates,” “*Australopithecus afarensis* – walked upright more than 3 million years ago,” “*Australopithecus africanus* – sometimes became prey of leopards and other large predators,” “*Paranthropus boisei* – large check bones support large teeth and strong powerful chewing muscles,” “*Homo erectus* – longest-lived member of the human family tree,” “*Homo heidelbergensis* – direct ancestor of modern humans,” “*Homo neanderthalensis* – one of the closest relatives of modern humans,” and “*Homo floresiensis* – adults were very short and had long feet.” *Homo floresiensis* is chosen. An animation begins with the photo of the author in the photobooth and slowly fades into a photo of the *Homo floresiensis* model, but with the eyes and mouth from the photobooth photo. It reads “You are becoming… *Homo floresiensis*. Adults were very short and had long feet. Transforming…” Once the photos are merged, the screen reads “You are now… *Homo floresiensis*. You live more than 50,000 years ago on an island in what is now Asia. You are very small…with a brain only about a third the size of modern humans. But you make tools and hunt a variety of animals… …and your small size helps you survive on an island with limited resources. Would you like your photo sent to you?”"
